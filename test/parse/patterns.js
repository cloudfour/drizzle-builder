...
describe('parse/patterns', () => {
  ...
  describe('overriding data with properties', () => {
    ...
    it('should allow override of name property', () => {
      expect(
        patternData.components.button.collection.items.aardvark
      ).to.contain.key('name');
      expect(
        patternData.components.button.collection.items.aardvark.name
    ...
    it('should derive IDs for patterns', () => {
      ...
      expect(patternData.components.collection.items.orange).to.include.key(
        'id'
      );
    ...
    it('should create IDs for patterns that give a retrieval path', () => {
      ...
      expect(utils.deepPattern(longId, patternData))
        .to.be.an('object')
  ...
  describe('parsing collections', () => {
    ...
    it('should order patterns per front matter', () => {
      ...
      expect(collection.patterns[3]).to.equal(
        collection.items['color-variation']
      );
