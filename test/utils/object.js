...
describe('utils/object', () => {
  describe('deepCollection', () => {
    it('should return deep collection', () => {
      ...
      expect(reference)
        .to.be.an('object')
        .and.to.contain.keys('name', 'items');
    });
    it('should throw if collection path non-extant', () => {
      const obj = { foo: {} };
      expect(
        utils.deepCollection.bind(utils, 'foo.bar.baz', obj, false)
  ...
  describe('deepObj', () => {
    ...
    it('should not create paths when indicated', () => {
      const obj = { foo: {} };
      expect(
        utils.deepObj.bind(utils, ['foo', 'bar', 'baz'], obj, false)
      ).to.throw(DrizzleError);
    });
  });
  describe('deepPattern', () => {
    ...
    it('should throw if pattern path non-extant', () => {
      const obj = { foo: {} };
      expect(utils.deepPattern.bind(utils, 'foo.bar.baz', obj, false)).to.throw(
        DrizzleError
      );
    });
  });
